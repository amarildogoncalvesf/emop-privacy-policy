...
**Identificadores:** br.com.emop.app (iOS) · com.emop.planner (Android)
...
O EMOP é um aplicativo de planejamento de estudos voltado para estudantes do Ensino Médio brasileiro. **Todos os dados que você insere ficam armazenados apenas no seu próprio dispositivo.** Não temos servidores que armazenam suas informações, não enviamos seu cronograma para nenhum lugar e não usamos ferramentas de análise de comportamento, rastreamento, publicidade ou relatórios de erro.

Em uma frase: o que você digita no app fica no seu celular — nada é enviado pela internet.
...
- Notas do ENEM ou de vestibulares, dados de provas escolares (matérias, data, dificuldade) e registros de redações, se aplicáveis ao seu objetivo;
...
- **Notificações:** após você terminar o onboarding, o app pergunta se pode enviar lembretes de estudo e avisos locais (lembrete diário antes do primeiro bloco, aviso de sequência em risco, lembretes de domingo para registrar simulados e planejar a semana). Todas as notificações são geradas e agendadas no próprio aparelho — nenhum servidor é envolvido. Você pode recusar e usar o app normalmente, ou desativar a qualquer momento em Configurações → Lembretes ou nas configurações do próprio sistema.
...
- Google Analytics, Firebase Analytics, Sentry, PostHog ou qualquer outra ferramenta de análise, métricas de uso ou relatórios de erro;
...
Nenhum dado — nem mesmo relatórios técnicos anônimos — é enviado a servidores nossos ou de terceiros, em nenhuma versão do app.

## 9. Segurança

Os dados que ficam no seu aparelho estão armazenados no sistema de armazenamento padrão do dispositivo, protegido pelo próprio sistema operacional (sandbox de aplicativos do iOS e do Android). Não há transmissão do seu conteúdo pela internet.
...
**Identifiers:** br.com.emop.app (iOS) · com.emop.planner (Android)
...
EMOP is a study-planning app for Brazilian high-school students. **All data you enter stays on your own device.** We do not have servers that store your information, we do not send your schedule anywhere, and we do not use behavior analytics, tracking, advertising, or crash-reporting services.

In one sentence: what you type into the app stays on your phone — nothing is sent over the internet.
...
- ENEM or college entrance exam scores, school exam data (subjects, date, difficulty), and essay-practice records, if applicable to your goal;
...
- **Notifications:** after you finish onboarding, the app asks if it may send local study reminders (a daily reminder before your first block, streak-at-risk warnings, and Sunday reminders to log mock exams and plan your week). All notifications are generated and scheduled on the device itself — no server is involved. You may decline and use the app normally, or disable them at any time in Settings → Reminders or in the system settings.

## 6. Children and teenagers

EMOP is primarily intended for high-school students (typically ages 14–18). Because the app does not collect or transmit personal data, no such information about minors is sent to third parties. We still recommend that parents or legal guardians supervise minors' use of the app.
...
- Google Analytics, Firebase Analytics, Sentry, PostHog, or any other analytics, usage-metrics, or crash-reporting tool;
...
No data — not even anonymous technical reports — is sent to our servers or to any third party, in any version of the app.

## 9. Security

Data stored on your device sits in the operating system's standard local storage, protected by the OS itself (iOS and Android app sandboxing). Your content is not transmitted over the internet.
